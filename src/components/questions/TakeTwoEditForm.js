...
const TakeTwoEditForm = (props) => {
	const { question, handleChange, handleSubmit, index, updateFieldChanged } = props 
		
	console.log(question, "are you here?")
	const [checked, setRadioValue] = useState({
	...
	if (typeOfQuestion === "Multiple Choice") {
		incorrectAnswers = (
			<>
				...
				<Form.Control
					key="incorrect2"
					placeholder="enter an incorrrect answer"
...
export default TakeTwoEditForm